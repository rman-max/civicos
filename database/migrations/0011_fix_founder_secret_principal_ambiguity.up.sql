-- Replace the initial founder-secret function implementation without altering
-- recorded migration 0010. PostgreSQL PL/pgSQL treats RETURNS TABLE output
-- names as variables, so the membership conflict target must name its unique
-- constraint explicitly.

BEGIN;

CREATE OR REPLACE FUNCTION core.ensure_founder_secret_principal(
